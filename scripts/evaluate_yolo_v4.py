...
WEIGHTS = ROOT / "runs" / "train" / "pcb_v4_scale" / "weights" / "best.pt"
TEST_IMAGES = ROOT / "outputs" / "pcb_yolo_dataset_v4" / "images" / "test"
TEST_LABELS = ROOT / "outputs" / "pcb_yolo_dataset_v4" / "labels" / "test"
OUT_DIR = ROOT / "outputs" / "eval_v4"
